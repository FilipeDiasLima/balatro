...
export function DefaultBlind({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "bg-background flex w-full flex-col items-center rounded-t-3xl p-2",
        blind === "small"
          ? "border-blue-darker"
          : blind === "big"
            ? "border-[#a56c00]"
        ...
        !selected && "brightness-50 grayscale-25",
    ...
    >
      <section className="flex w-full flex-col items-center gap-4 rounded-2xl border-4 border-[#395054] bg-[#2c3d40] p-4">
        <Button variant="secondary" className="w-full rounded-2xl text-4xl">
          Selecionar
        </Button>
        ...
        <div
          className={cn(
            "shadow-dark-menu-sm flex h-28 w-28 items-center justify-center rounded-full border-b-4",
            blind === "small"
        ...
        >
          <p
            className={cn(
              "text-center text-4xl leading-7 uppercase text-shadow-none",
              blind === "small"
                ? "text-white"
                : blind === "big"
                  ? "text-background"
        ...
        <div className="bg-deepgreen-darkest shadow-dark-menu-sm flex w-full flex-col items-center justify-center space-y-2 rounded-2xl p-2">
          <p className="leading-4">Pontue pelo menos</p>
          ...
          <p className="text-3xl leading-4">
            Recompensa:{" "}
      ...
      {blind !== "boss" && <p className="text-4xl">ou</p>}

      {blind !== "boss" && tag && onSkip && (
        <div className="bg-deepgreen-darkest flex w-fit flex-row items-center justify-center space-x-2 rounded-2xl p-1 pb-2">
          ...
          <Button onClick={() => onSkip(blind)} className="shadow-dark-menu-sm">
            Ignorar Blind
          </Button>
        </div>
      )}
      ...
      {blind === "boss" && (
        <div className="mt-4 flex w-fit flex-col items-center justify-center space-y-2 rounded-xl bg-black/10 px-1 py-2">
          <JumpingText
            text="Aumentar a Aposta"
            className="text-3xl leading-4"
          />
          <p className="text-xl leading-5">Aumentar todos os Blinds</p>
          <p className="text-3xl leading-4">Atualizar Blinds</p>
        </div>
      )}
    </motion.div>
  );
