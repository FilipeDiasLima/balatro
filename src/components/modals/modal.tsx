        ...
        {open ? (
          <ModalOverlay>
            <motion.div
              ...
              className={cn(
                "bg-background border-border shadow-light-menu fixed top-[50%] left-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 rounded-2xl border-4 p-4 pt-6 shadow-lg duration-200 sm:rounded-lg",
                className,
              )}
            >
              {children}
